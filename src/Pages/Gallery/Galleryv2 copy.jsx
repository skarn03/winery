          ...
          <div className="flex-[40%] sm:flex-[40%]  md:flex-[40%] lg:flex-[60%] flex flex-col justify-center ">
            <div className="">
              <div className="w-full flex justify-between">
                {/* Left Arrow */}
                <div className="border border-white px-4 py-4 rounded-full cursor-pointer group transition-all duration-300 hover:scale-105 hover:border-yellow-600"  onClick={handleNextLeft}>
                  <div

    ...
    <>
            ...
            <div className="grid grid-cols-3 gap-6 auto-rows-[220px]">
              {galleryImages.map((img, index) => (
                <div
                  ...
                  className={`
        relative overflow-hidden rounded-sm shadow-lg cursor-pointer transition-all duration-500 transform 
      ...
      `}
                >
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 transition duration-500 hover:opacity-50"></div>
                </div>
              ))}
            </div>
          </div>

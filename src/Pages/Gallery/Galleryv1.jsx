...
const Galleryv1 = () => {
  ...
  const handleNextLeft = () => {
    ...
    setTimeout(() => {
      ...
      setIsAnimating(false);
    }, 600); // Matches the same animation duration
  };
  return (
    <div className="flex flex-col h-[112vh] md:h-[112vh] lg:h-screen py-4 px-4  gap-y-4 md:gap-y-0 lg:gap-y-0">
      ...
      <motion.div className="flex-[100%]  mg:flex-[100%] lg:flex-[65%] flex flex-col sm:flex-col md:flex-col lg:flex-row gap-x-4 gap-y-8">
        ...
        <motion.div
          className="flex-[50%] rounded-4xl flex flex-col overflow-hidden px-4 "
          whileHover={{ scale: 1 }}
          whileTap={{ scale: 0.94 }}
          ...
          <div className="flex-[40%] sm:flex-[40%]  md:flex-[40%] lg:flex-[60%] flex flex-col justify-center ">
            <div className="">
              <div className="w-full flex justify-between">
                {/* Left Arrow */}
                <div className="border border-white px-4 py-4 rounded-full cursor-pointer group transition-all duration-300 hover:scale-105 hover:border-yellow-600"  onClick={handleNextRight}>
                  <div
        ...
        >
          ...
          <div className="flex-[90%] hidden sm:hidden md:flex lg:flex flex-row  px-2 gap-x-5 justify-between py-4">
